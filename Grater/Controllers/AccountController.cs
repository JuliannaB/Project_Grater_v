            ...
            if (ModelState.IsValid)
            {
             ...
             //   await UserManager.AddToRoleAsync(user.Id, "User");
                ...
                if (result.Succeeded)
                {
                    ...
                    //     var UserManager = new UserManager<ApplicationUser, int>(new UserStore<ApplicationUser, CustomRole, int, CustomUserLogin, CustomUserRole, CustomUserClaim>( ));

                    //    var role = new CustomRole();
                    //    role.Name = "User";
                    //     roleManager.Create(role);

                    var roleStore = new UserStore<ApplicationUser, CustomRole, int, CustomUserLogin, CustomUserRole, CustomUserClaim>(new ApplicationDbContext());
                    var manager = new ApplicationUserManager(roleStore);
                    //   await manager.CreateAsync(new CustomRole("User"));
                    await UserManager.AddToRoleAsync(user.Id, "User");
