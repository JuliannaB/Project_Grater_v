  ...
  //  [Authorize]
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
          ...
          User.Identity.GetUserId())  //nie koniecznie dobra zmiana
            };
            return View(model);
        }
        ...
        public async Task<ActionResult> LinkLoginCallback()
        {
            ...
            var result = await UserManager.AddLoginAsync(User.Identity.GetUserId<int>(), loginInfo.Login);  // little bit different than microfost change
...
#region Helpers
        ...
        private bool HasPassword()
        {
            ...
            // before  var user = UserManager.FindById(User.Identity.GetUserId());
            if (user != null)
            {
